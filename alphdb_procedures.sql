...
BEGIN
    ...
    INSERT INTO TERMINAL_USER (terminal, pid, status, username, password) VALUES(@terminal_mac, 0, 1, 'root', (SELECT password FROM ACCOUNT WHERE ACCOUNT.idaccount=idaccount));
    SET @terminal_user = LAST_INSERT_ID();
    
    INSERT INTO TERMINAL_GROUP (terminal, pid, status, groupname) VALUES(@terminal_mac, 0, 1, 'root');
