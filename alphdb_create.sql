...
ALTER TABLE `TERMINAL_USER` ADD CONSTRAINT `TERMINAL_USER_fk1` FOREIGN KEY (`gid`) REFERENCES `TERMINAL_GROUP`(`gid`);
...
ALTER TABLE `REFERENCIAL` ADD CONSTRAINT `REFERENCIAL_fk0` FOREIGN KEY (`category`) REFERENCES `REFERENCIAL`(`idreferencial`);

ALTER TABLE `PERMISSION` ADD CONSTRAINT `PERMISSION_fk0` FOREIGN KEY (`code`) REFERENCES `REFERENCIAL`(`idreferencial`);
